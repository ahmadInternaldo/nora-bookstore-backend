...
const error_exception_1 = require("../utils/error-exception");
let AuthGuard = class AuthGuard {
    ...
    async canActivate(context) {
        try {
            ...
            if (!token) {
                throw new common_1.UnauthorizedException('You must login first');
            }
            request['token'] = token;
            ...
            new error_exception_1.CustomError(error).execute();
        }
    }
